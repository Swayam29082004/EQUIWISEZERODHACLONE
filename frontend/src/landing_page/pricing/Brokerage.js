      ...
      <div id="charges-list" className="row justify-content-center mt-5">
        <div className="col-md-8">
          ...
          <div className="mb-5">
            ...
            <div className="mt-4">
              <h5 className="fw-normal fs-6">Securities/Commodities transaction tax (STT/CTT)</h5>
              <p className="text-muted small">Tax by the government when transacting on the exchanges. Charged on both buy and sell sides for equity delivery, and only on the selling side for intraday or F&O.</p>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
              <h5 className="fw-normal fs-6">DP (Depository participant) charges</h5>
              <p className="text-muted small">₹15.34 per scrip is charged when stocks are sold from your Demat account, irrespective of quantity.</p>
            </div>
            <div className="mt-4">
              <h5 className="fw-normal fs-6">Stamp charges</h5>
              <p className="text-muted small">Charges by the Government of India as per the Indian Stamp Act of 1899 for transacting on stock exchanges.</p>
            </div>
            <div className="mt-4">
            ...
            <div className="mt-4">
              ...
              <p className="text-muted small">Charged at ₹10 per crore + GST by the Securities and Exchange Board of India for regulating the markets.</p>
            </div>
          </div>
        </div>
      </div>
